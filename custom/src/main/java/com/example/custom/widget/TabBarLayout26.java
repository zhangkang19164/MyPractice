 ...
 * update 2018/3/15
 */
public class TabBarLayout26 extends LinearLayout {
    ...
    public TabBarLayout26(Context context) {
        this(context, null);
    }

    public TabBarLayout26(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabBarLayout26(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (i == 0 && mTabBarLeftBackgroundResId != 0) {
                ViewCompat.setBackground(
                        childAt, AppCompatResources.getDrawable(getContext(), mTabBarLeftBackgroundResId));
            } else if (i == childCount - 1 && mTabBarRightBackgroundResId != 0) {
                ViewCompat.setBackground(
                        childAt, AppCompatResources.getDrawable(getContext(), mTabBarRightBackgroundResId));
            } else {
                if (mTabBarBackgroundResId != 0) {
                    ViewCompat.setBackground(
                            childAt, AppCompatResources.getDrawable(getContext(), mTabBarBackgroundResId));
                }
            }
        }
    }
    ...
    class TabBarView extends AppCompatTextView {
        ...
        public TabBarView(Context context) {
            ...
            if (mTabBarBackgroundResId != 0) {
                ViewCompat.setBackground(
                        this, AppCompatResources.getDrawable(getContext(), mTabBarBackgroundResId));
            }
        ...
        private void updateTextAndIcon(@Nullable final TextView textView) {
            ...
            final CharSequence contentDesc = mTabBar != null ? mTabBar.getContentDescription() : null;
    ...
    public static class TabBarLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<TabBarLayout26> mTabBarLayoutRef;

        public TabBarLayoutOnPageChangeListener(TabBarLayout26 TabBarLayout) {
        ...
        public void onPageSelected(final int position) {
            final TabBarLayout26 tabBarLayout = mTabBarLayoutRef.get();
