 ...
 * 改造选择器
 */
public class PickerScrollViewReform extends View {
    ...
    public PickerScrollViewReform(Context context) {
        this(context, null);

    }

    public PickerScrollViewReform(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public PickerScrollViewReform(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
