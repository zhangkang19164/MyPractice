...
public class SelectedTabLayout extends LinearLayout {
    ...
    /**
     * Gravity used to fill the {@link SelectedTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link SelectedTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public SelectedTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelectedTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void addTabFromItemView(@NonNull TextView item) {
    ...
    /**
     * @deprecated Use {@link #addOnTabSelectedListener(SelectedTabLayout.OnTabSelectedListener)} and
     * {@link #removeOnTabSelectedListener(SelectedTabLayout.OnTabSelectedListener)}.
     */
    @Deprecated
    ...
    /**
     * Add a {@link SelectedTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via
     * {@link #removeOnTabSelectedListener(SelectedTabLayout.OnTabSelectedListener)}.</p>
     *
    ...
    /**
     * Remove the given {@link SelectedTabLayout.OnTabSelectedListener} that was previously added via
     * {@link #addOnTabSelectedListener(SelectedTabLayout.OnTabSelectedListener)}.
     *
    ...
    /**
     * Remove all previously added {@link SelectedTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Create and return a new {@link SelectedTabLayout.Tab}. You need to manually add this using
     * {@link #addTab(SelectedTabLayout.Tab)} or a related method.
     *
     * @return A new Tab
     * @see #addTab(SelectedTabLayout.Tab)
     */
    @NonNull
    public Tab newTab() {
    ...
    /**
     * Returns the current mode used by this {@link SelectedTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @SelectedTabLayout.Mode
    ...
    /**
     * The one-stop shop for setting up this {@link SelectedTabLayout} with a {@link ViewPager}.
     *
    ...
    private void addViewInternal(final View child) {
        if (child instanceof TextView) {
            addTabFromItemView((TextView) child);
        } else {
    ...
    public static final class Tab {
        ...
        SelectedTabLayout mParent;
        SelectedTabLayout.TabView mView;
    ...
    class TabView extends LinearLayout {
        private SelectedTabLayout.Tab mTab;
     ...
     * necessary calls back to the provided {@link SelectedTabLayout} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<SelectedTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(SelectedTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final SelectedTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
