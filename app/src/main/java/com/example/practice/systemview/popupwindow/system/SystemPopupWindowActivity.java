package com.example.practice.systemview.popupwindow.system;
...
import com.example.practice.systemview.dialog.system.SimpleAdapter;
...
public class SystemPopupWindowActivity extends AppCompatActivity {
    ...
    Button button06;
    @BindView(R.id.button_07)
    Button button07;
    @BindView(R.id.button_08)
    Button button08;
    @BindView(R.id.button_09)
    Button button09;
    @BindView(R.id.button_10)
    Button button10;
    @BindView(R.id.button_11)
    Button button11;
    ...
    @OnClick({R.id.button_01, R.id.button_02, R.id.button_03,
            R.id.button_04, R.id.button_05, R.id.button_06,
            R.id.button_07, R.id.button_08, R.id.button_09,
            R.id.button_10, R.id.button_11,})
    ...
    private void button10() {
        ...
        final EditText editText = (EditText) pupInput.findViewById(R.id.pup_input_edit);
