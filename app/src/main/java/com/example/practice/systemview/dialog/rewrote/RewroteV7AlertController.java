...
class RewroteV7AlertController {
    ...
    private int mButtonPanelLayoutHint = RewroteV7AlertDialog.LAYOUT_HINT_NONE;
    ...
    public RewroteV7AlertController(Context context, AppCompatDialog di, Window window) {
        mContext = context;
        mDialog = di;
        mWindow = window;
    ...
    public void installContent() {
        final int contentView = R.layout.rewrote_v7_alertdialog;
    ...
    private int selectContentView() {
        ...
        if (mButtonPanelLayoutHint == RewroteV7AlertDialog.LAYOUT_HINT_SIDE) {
    ...
    public static class AlertParams {
        ...
        public void apply(RewroteV7AlertController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final RewroteV7AlertController dialog) {
