package com.example.practice.expandablelistview.type.adapter;
...
public class ExpandableListViewTypeAdapter extends BaseExpandableListAdapter {
    ...
    public static final int CHILDREN_TYPE_ONE = 1;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (getGroupType(groupPosition) == GROUP_TYPE_NONE) {
            if (null == convertView) {
                convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_group_none, parent, false);
            }
            return convertView;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (childType == CHILDREN_TYPE_ONE) {
            if (null == convertView) {
                convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_child_one, parent, false);
        ...
        if (childType == CHILDREN_TYPE_TWO) {
            if (null == convertView) {
                convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_child_two, parent, false);
                childHolder = new ChildHolder();
                childHolder.textView = (TextView) convertView.findViewById(R.id.item_child_text);
                convertView.setTag(childHolder);
            } else {
