package com.example.system.expandablelistview.type.adapter;
...
import com.example.system.expandablelistview.type.bean.ChildBean;
import com.example.system.expandablelistview.type.bean.GroupBean;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (getGroupType(groupPosition) == GROUP_TYPE_ONE) {
            if (null == convertView) {
                ...
                groupHolder.textView = convertView.findViewById(R.id.item_group_text);
...
//            childHolder.textView.setText(childBean.getName());
        ...
        if (childType == CHILDREN_TYPE_THREE) {
            ...
            if (null == convertView) {
                ...
                childThreeHolder.textView_01 = convertView.findViewById(R.id.item_child_text_01);
                childThreeHolder.textView_02 = convertView.findViewById(R.id.item_child_text_02);
                childThreeHolder.textView_03 = convertView.findViewById(R.id.item_child_text_03);
