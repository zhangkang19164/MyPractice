package com.example.system.recyclerview.tradecommon.adapter;
...
import com.example.system.recyclerview.tradecommon.bean.TradeCommonBaseBean;
import com.example.system.recyclerview.tradecommon.bean.TradeCommonListBean;
import com.example.system.recyclerview.tradecommon.bean.TradeCommonTitleBean;
...
public class TradeCommonAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static class TradeCommonTitleViewHolder extends RecyclerView.ViewHolder {
        ...
        TradeCommonTitleViewHolder(View itemView) {
            super(itemView);
            textView = itemView.findViewById(R.id.trade_common_title);
        }
    }
    ...
    private static class TradeCommonListViewHolder extends RecyclerView.ViewHolder {
        ...
        TradeCommonListViewHolder(View itemView) {
            super(itemView);
            textView = itemView.findViewById(R.id.trade_common_list);
        }
    }
